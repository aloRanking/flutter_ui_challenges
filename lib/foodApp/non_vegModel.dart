class NonVegFood{
  ...
  const NonVegFood({this.id, this.imageLink, this.foodName, this.foodPrice,
    this.smallImages});


}

List<NonVegFood> nonVegFood =[
  ...
  const NonVegFood(
      ...
      foodName: 'Non-Vegetarian Dinner',
      foodPrice: '\$0.60',
      smallImages: [
  ...
  const NonVegFood(
      ...
      foodPrice: '\$0.60',
      smallImages: [
        'https://static.toiimg.com/photo/54327253/.jpg'
            'https://static.toiimg.com/photo/54327253/.jpg'
            'https://static.toiimg.com/photo/54327253/.jpg'
            'https://static.toiimg.com/photo/54327253/.jpg'
      ]
